...
pub const ONE_MIDNIGHT: Theme = Theme {
	keyword: Style::new().color(hex!("#C678DD")),
	variable_name: Style::new().color(hex!("#e07c75")),
	type_name: Style::new().color(hex!("#e5c07b")),
	background: Style::background().color(hex!("#060115")),
	line_numbers: Style::new().color(Color::rgb(60, 50, 90)),
};

/// The "empty" or "none" theme. This is used to print snippets in plain uncolored text.
pub const NO_THEME: Theme = Theme {
	keyword: Style::new(),
	variable_name: Style::new(),
	type_name: Style::new(),
